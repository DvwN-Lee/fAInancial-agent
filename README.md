...
"삼성전자(005930) 종합 분석 리포트"를 요청하면, Agent가 DART 재무제표 · KRX 주가 · 공시 문서 검색 등 MCP Tool을 자동 호출하여 분석 결과를 반환합니다. 하단의 Tool 뱃지에서 어떤 Tool이 호출되었는지 확인할 수 있습니다.
...
Tracing 탭에서 개별 요청의 session, latency를 목록으로 확인합니다.
